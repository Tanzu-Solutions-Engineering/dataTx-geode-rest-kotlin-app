package io.pivotal.services.dataTx.geode.rest.controller

import io.pivotal.services.dataTx.geode.client.GeodeClient
import io.pivotal.services.dataTx.geode.rest.domains.DataError
import io.pivotal.services.dataTx.geode.rest.exception.DataServiceSystemException
...
open class GeodeRegionService(val pdx: PDX = PDX()) {
    //@Autowired
